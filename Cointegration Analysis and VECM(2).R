...
#TITLE  : Cointegration ANALYSIS ON PAKISTAN CPI , M2 and Industrial Production
...
#H0: r =  0 , no cointegration relation present
...
#32.38 > 32.00 which falls in rejection region.So we move to r=1 here we sees
