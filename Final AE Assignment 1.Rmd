...
ts_seasonal(imports)
```
Seasonality in follow an upredictable pattern similar to that of exports. But in the June-July season exports are often at their peak during these years. The rest of the seasons are fairly inconsistent.
